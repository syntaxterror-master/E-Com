      ...
      items: [
        {
          ...
          href: "#",
          children: [
            { label: "Add Product", icon: FileText, href: "/addproducts" },
            { label: "All Products", icon: FileText, href: "/allproducts" },
            { label: "Active Products", icon: FileText, href: "/activeproducts" },
            { label: "Archived Products", icon: FileText, href: "/archivedproducts" },
          ],
        },
        {
          label: "Archived",
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-medium">{user.name} {user.lastname}</span>
                <span className="truncate text-xs font-medium">Role: {user.role}</span>
...
const AppSidebar = ({ user, ...props }: React.ComponentProps<typeof  Sidebar> & { user?: UserData }) => {
  return (
    <Sidebar {...props}>
      <SidebarHeader>
...
export function ApplicationShell1({ className, children, user }: ApplicationShell1Props & { children: React.ReactNode; user?: UserData }) {
  return (

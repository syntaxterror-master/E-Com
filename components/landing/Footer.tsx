...
const defaultProps: Footer2Props = {
  ...
  copyright: "© 2026 Exclusive All rights reserved.",
  legalLinks: [
...
const Footer = (props: Props) => {
  ...
  return (
    <section className={cn("py-32 bg-primary text-primary-foreground", className)}>
      <div className="container mx-auto">
        <footer>
          ...
          <div className="mt-8 flex flex-col justify-between gap-4 border-t border-border pt-8 text-xs font-medium  md:flex-row md:items-center">
            <p>{copyright}</p>
